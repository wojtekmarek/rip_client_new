...
class Intentions extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <TopMenu/>
                <form className="kontent intecionkontent">
                    <div key="headerformintencion" className="headerformintencion">Zgłoś Swoją intecję mszalną</div>
                    <label key="intencionformfield" className="intencionformfield" htmlFor="mass">Proponowany termin odprawienia Mszy</label>
                    <div data-testid="massselect">
                        <Select
                            key="select"
                            ...
                            inputId="mass"
                            onChange={(e) => {
                                this.handleChange("mass", e.value)
                            }}
                    ...
                    <label key="intencionformfieldtwo" className="intencionformfield" htmlFor="intencionscribe">Twoja
                        intencja</label>
                    <textarea
                        id="intencionscribe"
                        key="intencionscribe"
                        ...
                        cols={5}
                    />
                    <label key="intencionformfieldthree" className="intencionformfield" htmlFor="offeringinput">Zadeklaruj
                        Ofiarę</label>
                    <input
                        id="offeringinput"
                        key="offering"
                        ...
                        onBlur={(e) => {
                            this.validoffering(e.target.value)
                        }}
                    />
                    {errorofering ? [<div key="erroroffering" className="errorofering">Ofiara nie moze być mniejsza niż zero</div>] : ""}
                    {(!intencionrez) ? [
                        <button key="intencionbuttonsubmit" className="intencionbutton"
                                onClick={this.handleSubmit}>Zgłoś swoją intencję i dokonaj ofiary</button>
                        ...
                        , <button key="intencionbuttoncancel" className="intencionbutton "
                                  onClick={this.handleCancel}>Chce
                            anulować zgłaszanie intencji </button>
                    ]}
